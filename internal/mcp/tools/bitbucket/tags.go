...
func (h *Handler) getTagsHandler(ctx context.Context, req *mcp.CallToolRequest, input bitbucket.GetTagsInput) (*mcp.CallToolResult, GetTagsOutput, error) {
...
func (h *Handler) getTagHandler(ctx context.Context, req *mcp.CallToolRequest, input bitbucket.GetTagInput) (*mcp.CallToolResult, GetTagOutput, error) {
...
func AddTagTools(server *mcp.Server, client *bitbucket.BitbucketClient, permissions map[string]bool) {
	...
	mcp.AddTool[bitbucket.GetTagsInput, GetTagsOutput](server, &mcp.Tool{
		Name:        "bitbucket_get_tags",
		Description: "Get tags in a repository",
	}, handler.getTagsHandler)

	mcp.AddTool[bitbucket.GetTagInput, GetTagOutput](server, &mcp.Tool{
